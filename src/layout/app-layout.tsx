...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Contract', path: '/contracts', entity: 'contract', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
  ...
  { name: 'Payment', path: '/payments', entity: 'payment', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
