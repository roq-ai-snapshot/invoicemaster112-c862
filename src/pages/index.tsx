  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your B2B transactions with invoiceMaster1121 - Streamline invoicing, payments, and customization through our robust API, seamlessly integrating with your existing accounting infrastructure."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower your B2B transactions with invoiceMaster1121 - Streamline invoicing, payments, and customization
              through our robust API, seamlessly integrating with your existing accounting infrastructure.
            </Text>
            <Text>Manager</Text>
